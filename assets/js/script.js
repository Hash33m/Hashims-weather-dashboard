...
function displayUpdates() {
  ...
  /*Loop creates the 5 day forecast cards*/
  for (let i = 2; i <= 6; i++) {
    /* Element Creation */
...
/* Function allows user to search previous cities again */
...
/* Function allows the user to clear local storage via the UI */
